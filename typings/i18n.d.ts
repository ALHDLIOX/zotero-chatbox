...
export type FluentMessageId =
  ...
  | 'zorecto-pref-basic-col-setting'
  | 'zorecto-pref-basic-col-value'
  | 'zorecto-pref-basic-default-model-label'
  | 'zorecto-pref-basic-title'
  | 'zorecto-pref-endpoint'
  | 'zorecto-pref-error-apikey-required'
  | 'zorecto-pref-error-endpoint'
  | 'zorecto-pref-error-generic'
  | 'zorecto-pref-models-col-apikey'
  | 'zorecto-pref-models-col-model'
  | 'zorecto-pref-models-col-provider'
  | 'zorecto-pref-models-title'
  | 'zorecto-pref-nav-basic'
