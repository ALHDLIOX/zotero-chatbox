...
Defined in: [src/basic.ts:10](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/basic.ts#L10)
...
- [`ClipboardHelper`](Class.ClipboardHelper.md)
- [`FilePickerHelper`](Class.FilePickerHelper.md)
- [`GuideHelper`](Class.GuideHelper.md)
- [`LargePrefHelper`](Class.LargePrefHelper.md)
- [`PatchHelper`](Class.PatchHelper.md)
- [`VirtualizedTableHelper`](Class.VirtualizedTableHelper.md)
- [`ExtraFieldTool`](Class.ExtraFieldTool.md)
- [`ReaderTool`](Class.ReaderTool.md)
- [`UITool`](Class.UITool.md)
- [`ZoteroToolkit`](Class.ZoteroToolkit.md)
...
`BasicTool` \| [`BasicOptions`](Interface.BasicOptions.md)
...
```
updateOptions(source?): BasicTool;
```
