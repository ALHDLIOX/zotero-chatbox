...
Defined in: [src/managers/menu.ts:10](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/managers/menu.ts#L10)

Register \<menuitem\>, \<menupopup\>, or \<menuseperator> to Zotero right-click/window menus.

## Deprecated

Use `Zotero.MenuManager` instead. This API is planned to be removed in 6 months after Zotero 8 is officially released.
...
```
new MenuManager(base?): MenuManager;
```

Defined in: [src/managers/menu.ts:12](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/managers/menu.ts#L12)
...
register(
   ...
   options,
   insertPosition,
   anchorElement?): undefined | false;
```

Defined in: [src/managers/menu.ts:80](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/managers/menu.ts#L80)
...
`"item"` \| `MenuPopup` \| `"menuFile"` \| `"menuEdit"` \| `"menuView"` \| `"menuGo"` \| `"menuTools"` \| `"menuHelp"` \| `"collection"`

##### options

[`MenuitemOptions`](TypeAlias.MenuitemOptions.md)
...
The menuitem will be put before/after `anchorElement`. If not set, put at start/end of the menupopup.
...
```
unregister(menuId): void;
```

Defined in: [src/managers/menu.ts:214](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/managers/menu.ts#L214)
...
Defined in: [src/managers/menu.ts:218](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/managers/menu.ts#L218)
...
```
updateOptions(source?): MenuManager;
```
