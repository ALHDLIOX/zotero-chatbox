# Abstract Class: ManagerTool

Defined in: [src/basic.ts:489](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/basic.ts#L489)
...
- [`FieldHookManager`](Class.FieldHookManager.md)
- [`KeyboardManager`](Class.KeyboardManager.md)
- [`MenuManager`](Class.MenuManager.md)
- [`PromptManager`](Class.PromptManager.md)
...
```
new ManagerTool(data?): ManagerTool;
```
...
Defined in: [src/basic.ts:490](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/basic.ts#L490)
...
Defined in: [src/basic.ts:491](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/basic.ts#L491)
...
Defined in: [src/basic.ts:495](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/basic.ts#L495)
...
```
updateOptions(source?): ManagerTool;
```
