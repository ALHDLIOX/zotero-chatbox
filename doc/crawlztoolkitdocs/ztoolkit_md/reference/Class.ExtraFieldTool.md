# Class: ExtraFieldTool

Defined in: [src/tools/extraField.ts:6](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/extraField.ts#L6)
...
```
new ExtraFieldTool(data?): ExtraFieldTool;
```
...
Defined in: [src/tools/extraField.ts:59](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/extraField.ts#L59)
...
Whether to return all values if the field appears multiple times.
...
Defined in: [src/tools/extraField.ts:64](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/extraField.ts#L64)
...
```
getExtraFields(item, parser): Map<string, string>;
```

Defined in: [src/tools/extraField.ts:14](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/extraField.ts#L14)
...
Defined in: [src/tools/extraField.ts:15](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/extraField.ts#L15)
...
Defined in: [src/tools/extraField.ts:87](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/extraField.ts#L87)
...
Whether to save the item, default to true.
...
Defined in: [src/tools/extraField.ts:118](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/extraField.ts#L118)

Set a key-value pair in the item's extra field. If the key already exists, it can be overwritten or appended.
...
Whether to append to existing values, default to false
...
```
updateOptions(source?): ExtraFieldTool;
```
