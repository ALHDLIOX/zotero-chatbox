# Class: FilePickerHelper\<MODE>

Defined in: [src/helpers/filePicker.ts:21](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/helpers/filePicker.ts#L21)
...
Array\<\[hint string, filter string\]\>
...
the parent window. By default it is the main window
...
directory in which to open the file picker
...
new FilePickerHelper<MODE>(
   ...
   window?,
   filterMask?,
directory?): FilePickerHelper<MODE>;
```

Defined in: [src/helpers/filePicker.ts:40](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/helpers/filePicker.ts#L40)
...
`"html"` \| `"audio"` \| `"video"` \| `"text"` \| `"all"` \| `"images"` \| `"xml"` \| `"apps"` \| `"urls"`
...
```
open(): Promise<false | MODE extends "multiple" ? string[] : string>;
```

Defined in: [src/helpers/filePicker.ts:68](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/helpers/filePicker.ts#L68)

#### Returns

`Promise`\<`false` \| `MODE` *extends* `"multiple"` ? `string`\[\] : `string`\>
...
```
updateOptions(source?): FilePickerHelper<MODE>;
```
