...
Defined in: [src/tools/reader.ts:7](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/reader.ts#L7)
...
```
new ReaderTool(data?): ReaderTool;
```

Defined in: [src/basic.ts:40](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/basic.ts#L40)

#### Parameters

##### data?

Pass an BasicTool instance to copy its options.
...
### ~~addReaderTabPanelDeckObserver()~~

ts

```
addReaderTabPanelDeckObserver(callback): Promise<MutationObserver>;
```

Defined in: [src/tools/reader.ts:73](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/reader.ts#L73)
...
```
getReader(waitTime): Promise<undefined | ReaderInstance<"pdf" | "epub" | "snapshot">>;
```

Defined in: [src/tools/reader.ts:12](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/reader.ts#L12)
...
Wait for n MS until the reader is ready

#### Returns

`Promise`\<`undefined` \| `ReaderInstance`\<`"pdf"` \| `"epub"` \| `"snapshot"`\>\>
...
```
getReaderTabPanelDeck(): Deck;
```

Defined in: [src/tools/reader.ts:60](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/reader.ts#L60)
...
```
getSelectedAnnotationData(reader): undefined | AnnotationData;
```

Defined in: [src/tools/reader.ts:104](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/reader.ts#L104)
...
```
getSelectedText(reader): string;
```

Defined in: [src/tools/reader.ts:118](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/reader.ts#L118)
...
```
getWindowReader(): ReaderWindow[];
```

Defined in: [src/tools/reader.ts:34](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/tools/reader.ts#L34)
...
```
updateOptions(source?): ReaderTool;
```
