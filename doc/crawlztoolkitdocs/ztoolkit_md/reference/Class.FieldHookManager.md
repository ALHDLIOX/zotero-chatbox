# Class: FieldHookManager

Defined in: [src/managers/fieldHook.ts:11](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/managers/fieldHook.ts#L11)

Item field hooks manager.

## Extends

- [`ManagerTool`](Class.ManagerTool.md)
...
```
new FieldHookManager(base?): FieldHookManager;
```

Defined in: [src/managers/fieldHook.ts:28](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/managers/fieldHook.ts#L28)
...
[`ManagerTool`](Class.ManagerTool.md).[`constructor`](./Class.ManagerTool.md#constructor)
...
Defined in: [src/basic.ts:14](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/basic.ts#L14)

configurations.

#### Inherited from

[`ManagerTool`](Class.ManagerTool.md).[`_basicOptions`](./Class.ManagerTool.md#basicoptions)
...
[`ManagerTool`](Class.ManagerTool.md).[`_console`](./Class.ManagerTool.md#console)
...
[`ManagerTool`](Class.ManagerTool.md).[`patchSign`](./Class.ManagerTool.md#patchsign)
...
[`ManagerTool`](Class.ManagerTool.md).[`_version`](./Class.ManagerTool.md#version)
...
[`ManagerTool`](Class.ManagerTool.md).[`_version`](./Class.ManagerTool.md#version-1)
...
Defined in: [src/basic.ts:32](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/basic.ts#L32)
...
[`ManagerTool`](Class.ManagerTool.md).[`basicOptions`](./Class.ManagerTool.md#basicoptions)
...
Defined in: [src/basic.ts:497](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/basic.ts#L497)
...
[`ManagerTool`](Class.ManagerTool.md).[`_ensureAutoUnregisterAll`](./Class.ManagerTool.md#ensureautounregisterall)
...
[`ManagerTool`](Class.ManagerTool.md).[`_ensureMainWindowListener`](./Class.ManagerTool.md#ensuremainwindowlistener)
...
[`ManagerTool`](Class.ManagerTool.md).[`_ensurePluginListener`](./Class.ManagerTool.md#ensurepluginlistener)
...
[`ManagerTool`](Class.ManagerTool.md).[`_ensureRemoveListener`](./Class.ManagerTool.md#ensureremovelistener)
...
[`ManagerTool`](Class.ManagerTool.md).[`addListenerCallback`](./Class.ManagerTool.md#addlistenercallback)
...
[`ManagerTool`](Class.ManagerTool.md).[`createXULElement`](./Class.ManagerTool.md#createxulelement)
...
[`ManagerTool`](Class.ManagerTool.md).[`getGlobal`](./Class.ManagerTool.md#getglobal)
...
[`ManagerTool`](Class.ManagerTool.md).[`isXULElement`](./Class.ManagerTool.md#isxulelement)
...
[`ManagerTool`](Class.ManagerTool.md).[`log`](./Class.ManagerTool.md#log)
...
[`ManagerTool`](Class.ManagerTool.md).[`patch`](./Class.ManagerTool.md#patch)
...
Defined in: [src/managers/fieldHook.ts:63](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/managers/fieldHook.ts#L63)
...
(`field`, `unformatted`, `includeBaseMapped`, `item`, `original`) => `string`
...
[`ManagerTool`](Class.ManagerTool.md).[`register`](./Class.ManagerTool.md#register)
...
Defined in: [src/managers/fieldHook.ts:74](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/managers/fieldHook.ts#L74)
...
(`field`, `value`, `loadIn`, `item`, `original`) => `boolean`
...
Defined in: [src/managers/fieldHook.ts:85](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/managers/fieldHook.ts#L85)
...
(`field`, `baseField`, `original`) => `boolean`
...
[`ManagerTool`](Class.ManagerTool.md).[`removeListenerCallback`](./Class.ManagerTool.md#removelistenercallback)
...
```
unregister(type, field): void;
```

Defined in: [src/managers/fieldHook.ts:98](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/managers/fieldHook.ts#L98)
...
[`ManagerTool`](Class.ManagerTool.md).[`unregister`](./Class.ManagerTool.md#unregister)
...
Defined in: [src/managers/fieldHook.ts:105](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/managers/fieldHook.ts#L105)
...
[`ManagerTool`](Class.ManagerTool.md).[`unregisterAll`](./Class.ManagerTool.md#unregisterall)
...
```
updateOptions(source?): FieldHookManager;
```
...
[`ManagerTool`](Class.ManagerTool.md).[`updateOptions`](./Class.ManagerTool.md#updateoptions)
...
[`ManagerTool`](Class.ManagerTool.md).[`getZotero`](./Class.ManagerTool.md#getzotero)
