...
Defined in: [src/helpers/guide.ts:8](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/helpers/guide.ts#L8)
...
```
new GuideHelper(): GuideHelper;
```

Defined in: [src/helpers/guide.ts:11](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/helpers/guide.ts#L11)
...
Defined in: [src/helpers/guide.ts:9](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/helpers/guide.ts#L9)
...
```
addStep(step): GuideHelper;
```

Defined in: [src/helpers/guide.ts:15](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/helpers/guide.ts#L15)
...
```
addSteps(steps): GuideHelper;
```

Defined in: [src/helpers/guide.ts:20](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/helpers/guide.ts#L20)
...
```
highlight(doc, step): Promise<Guide>;
```

Defined in: [src/helpers/guide.ts:39](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/helpers/guide.ts#L39)
...
```
show(doc): Promise<Guide>;
```

Defined in: [src/helpers/guide.ts:25](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/helpers/guide.ts#L25)
...
```
updateOptions(source?): GuideHelper;
```
