...
Defined in: [src/helpers/dialog.ts:7](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/helpers/dialog.ts#L7)
...
Defined in: [src/helpers/dialog.ts:22](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/helpers/dialog.ts#L22)
...
[`UITool`](Class.UITool.md).[`constructor`](./Class.UITool.md#constructor)
...
[`UITool`](Class.UITool.md).[`_basicOptions`](./Class.UITool.md#basicoptions)
...
[`UITool`](Class.UITool.md).[`_console`](./Class.UITool.md#console)
...
[`UITool`](Class.UITool.md).[`elementCache`](./Class.UITool.md#elementcache)
...
[`UITool`](Class.UITool.md).[`patchSign`](./Class.UITool.md#patchsign)
...
[`UITool`](Class.UITool.md).[`_version`](./Class.UITool.md#version)
...
[`UITool`](Class.UITool.md).[`_version`](./Class.UITool.md#version-1)
...
[`UITool`](Class.UITool.md).[`basicOptions`](./Class.UITool.md#basicoptions)
...
[`UITool`](Class.UITool.md).[`_ensureMainWindowListener`](./Class.UITool.md#ensuremainwindowlistener)
...
[`UITool`](Class.UITool.md).[`_ensurePluginListener`](./Class.UITool.md#ensurepluginlistener)
...
[`UITool`](Class.UITool.md).[`_ensureRemoveListener`](./Class.UITool.md#ensureremovelistener)
...
[`UITool`](Class.UITool.md).[`addListenerCallback`](./Class.UITool.md#addlistenercallback)
...
[`UITool`](Class.UITool.md).[`appendElement`](./Class.UITool.md#appendelement)
...
[`UITool`](Class.UITool.md).[`createElement`](./Class.UITool.md#createelement)
...
[`UITool`](Class.UITool.md).[`createXULElement`](./Class.UITool.md#createxulelement)
...
[`UITool`](Class.UITool.md).[`getGlobal`](./Class.UITool.md#getglobal)
...
[`UITool`](Class.UITool.md).[`insertElementBefore`](./Class.UITool.md#insertelementbefore)
...
[`UITool`](Class.UITool.md).[`isXULElement`](./Class.UITool.md#isxulelement)
...
[`UITool`](Class.UITool.md).[`log`](./Class.UITool.md#log)
...
Defined in: [src/helpers/dialog.ts:185](/Users/epsaliox/Library/CloudStorage/GoogleDrive-alhdliox@gmail.com/My Drive/proj/zotero-plugin-toolkit/src/helpers/dialog.ts#L185)
...
[`UITool`](Class.UITool.md).[`parseXHTMLToFragment`](./Class.UITool.md#parsexhtmltofragment)
...
[`UITool`](Class.UITool.md).[`patch`](./Class.UITool.md#patch)
...
[`UITool`](Class.UITool.md).[`removeListenerCallback`](./Class.UITool.md#removelistenercallback)
...
[`UITool`](Class.UITool.md).[`replaceElement`](./Class.UITool.md#replaceelement)
...
[`UITool`](Class.UITool.md).[`unregisterAll`](./Class.UITool.md#unregisterall)
...
[`UITool`](Class.UITool.md).[`updateOptions`](./Class.UITool.md#updateoptions)
...
[`UITool`](Class.UITool.md).[`getZotero`](./Class.UITool.md#getzotero)
